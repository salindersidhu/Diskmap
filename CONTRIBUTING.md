# Contributing to Diskmap

Diskmap is an open source community project, and everyone is welcome to contribute. This short guide will assist you with the workflow required in successfully having your features and bug fixes merged into the project.
...
The best approach to contribute code to Diskmap is to fork the [main repository](https://github.com/salindersidhu/Diskmap) on GitHub, then submit a pull request.
...
```bash
git clone https://github.com/USERNAME/Diskmap.git

# If you have an SSH key setup with GitHub
git clone git@github.com:USERNAME/Diskmap.git
...
git remote add upstream https://github.com/salindersidhu/Diskmap.git
```
...
If you find a bug in the code, please submit a ticket to the [Bug Tracker](https://github.com/salindersidhu/Diskmap/issues).
...
- The version of Diskmap you are using.
